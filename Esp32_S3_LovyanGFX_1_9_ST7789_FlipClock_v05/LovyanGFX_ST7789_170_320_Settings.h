...
// SPIバスの設定
      ...
      cfg.pin_sclk = 8;                  // set SPI SCLK pin number SCK
      cfg.pin_mosi = 9;                  // set MOSI pin number of SPI SDI
      cfg.pin_miso = -1;                  // set SPI's MISO pin number (-1 = disable) SDO
      cfg.pin_dc = 7;                     // set SPI D/C pin number (-1 = disable) RS
...
//*/
    ...
    { // 表示パネル制御の設定を行います。
      ...
      cfg.pin_cs = 6;                      // pin number to which CS is connected (-1 = disable)
